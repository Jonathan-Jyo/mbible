...
찬미가 음원 내려받기 — 앱의 '항상예수께로_찬미' 폴더를 만들어 준다.
  ...
  만드는 것 (출처 칸을 두고 그 안에 담기를 권한다):
      항상예수께로_찬미/
      └ 연합회/            ← --out 으로 정한 곳
          ├ 반주/  001.mp3 · 444.mp3 · 444_pitch_-2_tempo_0_pitched.mp3 …
          └ 찬양/  013.mp3 …

      python3 get-hymn-audio.py 1-759 --out ~/Desktop/항상예수께로_찬미/연합회

  같은 곡을 여러 곳에서 구하면 출처마다 칸을 나눈다. 한 칸에 몰아넣으면
  나중 파일이 앞엣것을 덮어써 무엇을 듣는지 알 수 없게 된다.

...
def main():
    ...
    if broken:
        ...
        for n, ln in broken[:8]:
            print(f"      {n}장 — {ln}")
    print("\n다음: 매일찬양 › 찬미가 › 곡 열기 › 🎵 음원 › [주소록 파일 고르기] 에서 넣으세요.")
